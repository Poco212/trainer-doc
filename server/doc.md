...
# packages
```
pacstrap /mnt intel-ucode linux-hardened linux-lts-hardened linux-firmware mkinitcpio lvm2 base base-devel neovim firewalld openssh
```
# fstab
```
...
## desktop
```
pacman -S xfce4 sddm networkmanager network-manager-applet
```
## service
```
